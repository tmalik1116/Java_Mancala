...
public class MancalaDataStructure {
    ...
    //accessor method for data List
    public Countable getData(int index){
        return data.get(index);
    }

    public void setData(int index, Countable toSet){
        data.get(index).setStones(toSet.getStoneCount());
    }

    //accessor method for lastStoneIndex
    public int getLastStoneIndex() {
        return lastStoneIndex;
    }
    
    public void setLastStoneIndex(int index){
    ...
    private void setSkipPlayer(int playerNum) {
        ...
        //System.out.println(playerNum + playerSkip);
    }
    ...
    public void setIterator(int startPos, int playerNum, boolean skipStartPit) {
        ...
        //System.out.println("skip" + playerSkip);
        if (skipStartPit) {
            setSkipPit(startPos);
        }
    }
